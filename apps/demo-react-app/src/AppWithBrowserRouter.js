...
// Helper function to determine the basename
const getBasename = () => {
  // Check if we're in a federated environment
  if (window.location.pathname.includes('/demo-app')) {
    return '/demo-app';
  }
  // If running standalone, no basename needed
  return '';
};

// Main app with adaptive router

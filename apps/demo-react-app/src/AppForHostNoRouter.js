...
// Navigation component using state instead of React Router
const Navigation = ({ currentView, setCurrentView }) => {
  ...
  return (
    <nav style={navStyle}>
      ...
      <button 
        style={currentView === 'home' ? activeLinkStyle : linkStyle}
        onClick={() => setCurrentView('home')}
      >
        Home
      </button>
      <button 
        style={currentView === 'dashboard' ? activeLinkStyle : linkStyle}
        onClick={() => setCurrentView('dashboard')}
      >
        Dashboard
      </button>
      <button 
        style={currentView === 'settings' ? activeLinkStyle : linkStyle}
...
// Main app that doesn't use React Router - safe for embedding in host applications that already have routers
const AppForHostNoRouter = () => {
...
export default AppForHostNoRouter;

...
const Navigation = ({ basePath = '/demo-app' }) => {
...
// Main app that integrates with the host's router - NO Router wrapper, just Routes
const AppForHostWithRoutes = ({ basePath = '/lazy-demo' }) => {
  return (
    <div style={{ 
      width: '100%',
      maxWidth: '100%',
      ...
      <div style={{ 
        ...
        {/* This Routes component will integrate with the host's Router context */}
        <Routes>
...
export default AppForHostWithRoutes;
